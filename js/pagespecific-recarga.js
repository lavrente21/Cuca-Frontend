...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (confirmDepositButton) {
        confirmDepositButton.addEventListener('click', async (event) => {
            ...
            // Mostra o indicador de carregamento apenas depois de todas as validações
            showLoading(true);
            ...
            try {
                // O URL DO BACKEND AGORA É O RAILWAY
                ...
                if (response.ok) {
                    ...
                    showLoading(false); // Garante que o indicador seja ocultado antes de redirecionar
                    setTimeout(() => {
                ...
                showLoading(false); // Oculta o carregador em caso de erro de conexão
            }
        });
    }
});
